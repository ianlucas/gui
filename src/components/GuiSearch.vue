<template>
  ...
  >
    ...
    >
      <svg viewBox="0 0 551.13 551.13" xmlns="http://www.w3.org/2000/svg"><path d="M275.565 361.679L51.668 137.783H0l275.565 275.565L551.13 137.783h-51.668z"/></svg>
    </button>
    <button
      :disabled="!elements.length"
      class="gui-search-button"
      ...
      @mousedown.left.prevent="moveCursor(-1)"
    >
      <svg viewBox="0 0 551.13 551.13" xmlns="http://www.w3.org/2000/svg"><path d="M275.565 189.451l223.897 223.897h51.668L275.565 137.783 0 413.348h51.668z"/></svg>
    </button>
    <span
